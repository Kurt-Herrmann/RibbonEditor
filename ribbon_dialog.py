...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("resources/gifs/l.gif"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        icon.addPixmap(QtGui.QPixmap("resources/gifs/l_sel.gif"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("resources/gifs/r.gif"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        icon1.addPixmap(QtGui.QPixmap("resources/gifs/r_sel.gif"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("resources/gifs/m.gif"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        icon2.addPixmap(QtGui.QPixmap("resources/gifs/m_sel.gif"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("resources/gifs/a.gif"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.Off)
        icon3.addPixmap(QtGui.QPixmap("resources/gifs/a_sel.gif"), QtGui.QIcon.Mode.Active, QtGui.QIcon.State.On)
